...
router.register(r'teheji-report', TehejiReportViewSet, basename="teheji-report")
...
urlpatterns = [
    ...
    path('api/unpaid-suspended/', unpaid_suspended, name='unpaid-suspended'),
    path('api/quick-pay/', quick_pay, name='quick-pay'),
