...
SECRET_KEY = 'django-insecure-xcni%5wzj3ph19+__0$k@lme$0pd&h(amr2bq$c53oq=2vnr4l'
...
# SIMPLE_JWT = {
#     "ACCESS_TOKEN_LIFETIME": timedelta(days=1),  # or more
...
AUTH_USER_MODEL = 'school_app.Utilisateur'
APPEND_SLASH = False
